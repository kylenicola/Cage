	...
	public void onCreate(Bundle savedInstanceState) 
	{
		...
		cageCluesVideo.setOnCompletionListener(new OnCompletionListener() {
			...
			public void onCompletion(MediaPlayer mp) {
				...
				// Updates count
				CageClues.this.runOnUiThread(new Runnable() {

					@Override
					public void run() {

						// If someone watches this 2^31-1 times...which i mean, just wow.
						if(CageClues.this.cageCluesCount + 1 < Integer.MAX_VALUE)
						{
							CageClues.this.cageCluesCount += 1;
						}
						int cageCluesCount = CageClues.this.cageCluesCount;
						...
						// update description
						if(cageCluesCount - 1 < CageClues.this.descriptionsLen)
						{
...
//		Log.d(TAG, "onstart videotime: " + String.valueOf(cageCluesVideo.getCurrentPosition()));
	...
	private void updatePrefs()
	{
		...
		int curTimesWatched = prefs.getInt(Stats.CAGECLUES_TIMES_WATCH, -1);
